...
case 'username':
formErrors.username=value.length<6 && value.length>0 ? 'minimum 3 charactors required': "";
break;
case 'password':
formErrors.password=value.length<6 && value.length>0 ? 'minimum 3 charactors required': "";
default:
  break;
}
...
render(){
  const { formErrors } = this.state;
    return(
       ...
       <Link to="/" type="submit" class="signup" >Sign up</Link>
